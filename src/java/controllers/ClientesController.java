...
public class ClientesController implements Serializable {
    ...
    @EJB
    private facades.ClientesFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return ClientesController.getSelectItems(getFacade().findAllOrdered(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return ClientesController.getSelectItems(getFacade().findAllOrdered(), true);
    ...
    public static SelectItem[] getSelectItems(List<Clientes> entities, boolean selectOne) {
        ...
        for (Clientes x : entities) {
            items[i++] = new SelectItem(x, x.getNome() + " - " + x.getTelefone());
        }
        return items;
    }
}
