...
public class TipoController implements Serializable {
    ...
    @EJB
    private facades.TipoFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        ...
        List<Tipo> tipoList;
        tipoList = getFacade().findAll();

        return TipoController.getSelectItems(tipoList);
    }
    ...
    public static SelectItem[] getSelectItems(List<Tipo> entities) {
